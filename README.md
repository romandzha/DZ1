...
--- было рассказано в прошлые разы ---\
...
ТЗ пишется бизнес-аналитиком!
Конкретные технические реализации пишутся на этапе технического проекта в техпроекте
...
Мой конспект по тз на дз
ТЗ на проект
Не 3 страницы! Объем такой, чтобы было не стыдно 10 млн заплатить будь я сам инвестором
Модули/подмодули
“Структура выполнения” - на первом слайде кто что делал
Документ + преза
На слайде крупноуровнево блоки, не текст
